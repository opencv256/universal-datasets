...
MAPPER = {'normal': 0, # 정상
          ...
          'cardiomegaly': 9, # 심장 비대 -> 원인 질환에 상관없이 심장이 커진 상태
          'nodule': 10, # 폐 결절 -> 폐 내부에 생긴 지름 3cm 미만의 작은 구상 병변
          'pneumothorax': 11, # 기흉 -> 허파와 흉부벽 사이의 흉강에 공기가 비정상적으로 모이는 현상
          'pneumonia': 12, # 폐렴 -> 세균이나 바이러스, 곰팡이 등의 미생물로 인한 감염으로 발생하는 폐의 염증
          'fibrosis': 13, # 폐 섬유종 -> 폐 조직이 굳어서 심각한 호흡 장애를 불러일으키는 호흡기 질환
          'infiltration': 14 # 침윤음영 -> 조직이나 세포에 정상이 아닌 물질이나 비정상적으로 과다한 물질이 축적, 침착하는 것, 또는 축적된 물질 
          }
